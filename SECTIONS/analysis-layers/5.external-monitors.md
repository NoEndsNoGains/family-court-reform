...
The Transparency Implementation Group (TIG) and Financial Remedies Consultative & Transparency Group (FRCTG) function as internal observers—comprising judges, MoJ/HMCTS officials, DfE/Cafcass representatives, and legal experts—responsible for designing transparency reforms following the 2021 Transparency Review.[^TIG_Overview] Analysis of their combined minutes (n=36 documents, 2021–2024) reveals the same architectural voids documented externally by the Transparency Project (TP) and corroborated through a full analysis of TP’s blog corpus (n=67 posts, November 2024–October 2025),[^TP_Analysis] confirming that the barriers to transparency are structural rather than positional.
