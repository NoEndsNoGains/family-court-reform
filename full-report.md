...
> ## How to Help
>
> **Don't edit directly—use the contribution pathways:**  
> - [Flag an issue](https://github.com/NoEndsNoGains/family-court-reform/issues/new/choose)  
> - [Submit a pull request](https://github.com/NoEndsNoGains/family-court-reform/fork)  
> - [See open tasks](https://github.com/NoEndsNoGains/family-court-reform/issues?q=is%3Aopen+is%3Aissue)  
> 
...
## Executive Summary: The Iguana on the Wall. Why we need a justice system that remembers better than a lizard.
...
**CHAPTERS 1-5: INTRODUCTION & CONTEXT**
- Research design, methodology, theoretical framework

**CHAPTER 6: THE FIVE-LAYER ANALYSIS**
...
- Layer 4: User Experience (LiPs/Litigants)
- Layer 5: External Observation & Internal Reform (Observers & Architects)
- Cross-Layer Synthesis: How Layers Interact

**CHAPTER 7: THE MISSING VOICE – CHILDREN'S EXCLUSION**

**CHAPTER 8: PROCEDURAL SOLUTIONS**
- Fixing the architecture within existing framework

**CHAPTER 9: PARADIGMATIC REFORMS**
- Structural changes when procedural fixes insufficient
...
But something happened while I was writing this section. Something I wasn't expecting.
I was mapping out all the barriers — you've heard me complain about them. The forms that don't work. The judges who won't release transcripts. The lawyers who gatekeep. The researchers who can't get access. Five layers of obstacles, all blocking the light from getting in.
And I was so busy fighting for transparency that I almost missed something fundamental.
Something that, when I finally saw it, rocked everything.

Here's what I missed:
I kept asking how do we make the system more transparent? But I never asked transparent for whom?
The whole system says it exists for children. Children's welfare. Children's interests. Children's best interests paramount.
But when I looked at who gets to decide what transparency means — who writes the policies, who shapes the guidance, who decides which cases get published and how —
Children weren't there.
Not as participants. Not as consultants. Not even as an afterthought.
The system that claims to serve them was designed entirely without them.

At first I pushed back against my own realisation.
Of course children aren't consulted on policy, I thought. They're young. It's complicated. You can't ask an 8-year-old to weigh Article 8 against Article 10.
But then I looked at what happens when children are consulted.
In 2016, young people were asked to review published judgments. To check if the anonymisation worked. To flag if they could still be identified.
But they weren't asked: should these be published at all?
That question was already decided. They were just checking the adults' homework.
And when they said things like — "graphic details of sexual abuse... available to the world forever" — the consultation wasn't designed to hear that.
It couldn't. The frame was too narrow.

So I started asking a different question. The one I think we should have asked from the beginning:
Who has the right to tell a child's story?
I've been fighting for transparency — for judgments to be published, for the system to be seen.
But those judgments are about children. They contain the worst moments of children's lives. And once they're published, they're out there. Forever.
The child who's 8 when the judgment goes online is still searchable at 28. At 48.
And there's no mechanism — none — for that adult to say: I didn't consent to this.

You see where this rocked me?
I wanted transparency to fix the system. But I never asked whether transparency — this kind of transparency — is what children would want.
Maybe they'd say yes. Publish everything. Hold the system accountable. Maybe they'd say no. Keep my story private. It's mine. Maybe they'd say something I haven't imagined.
I don't know.
Because no one asked them.

And it gets worse.
I realised the question isn't just should cases be published? It's deeper than that.
It's: by what authority does the system claim the right to write, own, and broadcast a child's life story?
The judgment is the judge's version of what happened. But what if the child — now grown — remembers it differently? What if the official story isn't their story?
Who decided the institution's narrative gets to be the narrative?
And when the child's privacy is weighed against "the public interest" — who decided the public's interest matters more?
Adults did. Without asking.

I think I know why the system doesn't ask these questions.
Because the answers might be uncomfortable.
If you ask by what right do we publish children's stories? — you might have to admit: we have power, but not necessarily right.
That would threaten too much. Judges need published cases for precedent. Lawyers build reputations on reported judgments. Reformers — people like me — need visible cases to prove the system fails.
We all benefit from transparency. But we're not the ones exposed by it.
Children are.

I'm not saying transparency is wrong. I still think secrecy protects bad practice. I still think sunlight is the best disinfectant.
But I'm saying I was so focused on opening the system that I forgot to ask who might be harmed by the opening.
And the people most likely to be harmed are the ones with no voice in the policy.

So what do I do with this?
I don't have clean answers. Not yet.
I made up some questions I think children might ask: Will kids at school find this? Why wasn't I asked? Could you use statistics instead of my actual story? Can I revisit this decision when I'm 18?
But these are guesses. Adult guesses. Children might care about completely different things. They might reject my whole framing.
I won't know until someone asks them.

There's one more thing that haunts me.
All this debate about transparency — it's only about judgments. The judge's polished summary.
But what about transcripts? The raw record of what was actually said? What parents argued, what experts observed, what the child's voice sounded like through their guardian?
Those stay locked. Even from adults trying to understand their own childhoods.
And the recordings? Often destroyed before children grow up.
So the child becomes an adult, wants to understand what happened to them, and finds: the summary is public, but the truth is gone.

I still believe in transparency. I still think the system needs light.
But I believe in something else now too:
A transparent system that doesn't ask children what transparency means to them isn't a system that serves children.
It's a system that serves adults who've convinced themselves they're acting in children's interests.
That's not good enough.

That's what this text is all about.
It is the part where my own argument came back to challenge me. Where I had to admit that fighting for openness doesn't automatically mean fighting for children.
I don't know what the right answer is. But I know we've been asking the wrong question. I was asking the wrong question. 
So what is the right question? Well, for now…
Can we eat?
x
